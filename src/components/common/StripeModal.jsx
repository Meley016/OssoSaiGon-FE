...
export default function StripeModal({ isOpen, onClose, orderId, total }) {
  ...
  const handleStripePayment = async () => {
    ...
    try {
      ...
      if (!card) throw new Error("Card element chưa sẵn sàng");
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl p-8 space-y-6 relative">
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mt-2">
            Số tiền: <span className="font-bold text-black">{total.toLocaleString()}₫</span>
          </p>
        </div>
