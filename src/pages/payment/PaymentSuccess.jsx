    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#ffe6e6] p-6">
      ...
      <div className="mt-6 w-full max-w-4xl bg-white shadow-lg p-6 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <p>
            <strong>{t("payment.orderCode")}:</strong> {order.orderCode}
          </p>
          <p>
        ...
        {order.promotionId && (
          <div>
            <p>
              <strong>{t("payment.promotion")}:</strong>{" "}
              {order.promotionId.name || order.promotionId.code}
            </p>
          </div>
        )}
